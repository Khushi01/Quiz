...
<table>
    <td width="10%">
     <img border="0" src="images/2q.jpg" height="150px" align="left"></td>
  </tr>
</table>
...
<!--<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#000000" background="img/blackbar.jpg">
  ...
  ?>
	...
	{
	 echo "<div align=\"right\"><h1><strong><a href=\"index.php\"> Home </a>|<a href=\"signout.php\">Signout</a></strong></h1></</div>";
	 }
	 else
	 {
	 	echo "&nbsp;";
